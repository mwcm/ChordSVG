class ChordBox{
    ...
    draw(positions, fingerings) {

        if (this.params.tuning.length === 0) {
        ...
        if (!positions.some(el => el != 'x' && int(el) > 5)) {
            ...
            // this.drawText(this.x - this.spacing / 2 - this.spacing * 0.1, this.y + this.fretSpacing * position, position);
        }
        ...
        // TODO: Come back to this, check how it's interpreted in chordjs
        // Draw barres
